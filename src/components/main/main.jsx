...
import MainProductImg_2 from "../assets/mainProduct_1.png";
import MainProductImg_3 from "../assets/mainProduct_2.png";
import MainProductImg_4 from "../assets/mainProduct_3.png";
      ...
      <Box maw="100%" w="100%" h="100vh">
        ...
        <Box bg="#333" maw="100%" w="100%" className={Style.mainProducts}>
          <Flex>
            ...
            >
              <Box>
                <Text mt={30} fz={90} fw={700} w={500} lts={2} c="#FFFFFF">
                  BUILT FOR FLIGHT
                </Text>
                <Text mt={30} ta="center" w={450} fz={20} lts={1} c="#fff">
                  THIS SPECIAL EDITION TAKES IT A STEP FURTHER BY ADDING GOLDEN
                  ACCENTS ON THE FOREFOOT SWOOSH AND THE HOME PLATE HANGTAG,
                  WHILE STRIKES OF RED ARE SEEN THROUGHOUT THE STRAPS,
                  HEEL-TABS, AND OTHER MINUTIA.
                </Text>
                <Button
                  ml={120}
                  mt={30}
            ...
            <Box maw="52%" w="52%" className={Style.mainProducts} bg="orange">
              <Carousel
                w="100%"
                className={Style.mainProducts}
                dragFree
